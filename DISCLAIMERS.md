...
Improvement depends on many factors (how often you practice, your starting point, your keyboard, your existing habits). The descriptions of typical progress in the README are general expectations based on common learning principles, not promises about your results.
...
Typing code snippets builds familiarity with how the symbols and patterns *look and feel* to type. It does **not** teach what the code means or how to write correct queries or programs. It is a typing aid, full stop. Use real courses and documentation to learn the concepts.

## Ergonomics are your responsibility

This app cannot see your posture, desk, chair, or keyboard. Good setup, regular breaks, and stopping when something hurts are up to you. Short sessions are encouraged for learning reasons *and* for your body.

## Keyboard layout

The on-screen finger hints and the "you hit X, the target is to the right" coaching assume a **standard US QWERTY layout**. On other layouts the directional guidance may be wrong. (If you use a different layout and want it supported, open an issue.)
...
This software is provided without warranty of any kind, as stated in the [LICENSE](LICENSE). Use it at your own discretion.
